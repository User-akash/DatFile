System.register("magicType", [], function (exports_1, context_1) {
    "use strict";
    var MagicType;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_1("default", MagicType);
        }
    };
});
System.register("best", ["magicType"], function (exports_2, context_2) {
    "use strict";
    var magicType_1, HumbagerMenu, menu, menuHub, menus, text;
    var __moduleName = context_2 && context_2.id;
    return {
        setters: [
            function (magicType_1_1) {
                magicType_1 = magicType_1_1;
            }
        ],
        execute: function () {
            HumbagerMenu = (function () {
            ...
            menu = document.querySelector(".hambaga");
            menuHub = document.querySelectorAll(".menu-hub");
            menus = document.querySelectorAll(".menus");
            if (menu) {
                new HumbagerMenu(menu, [menus[0], menuHub[0]]);
            }
            text = document.querySelector(".spacial h3");
            if (text) {
                new magicType_1.default(text, { delay: 5000, texts: ["Shadhin is my name", "I am work as developer", "this Type Script "] });
            }
        }
    };
});
